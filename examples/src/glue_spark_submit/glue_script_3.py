...
"""
This Glue ETL Script write data to an existing Glue catalog table with partitions,
...
- how to write data to S3 and add partition to glue catalog automatically
"""
...
prefix = (
    f"projects/aws_glue_container_launcher/glue_spark_submit/test1/{database}/{table}/"
)
# ref: https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-crawler-pyspark-extensions-dynamic-frame-writer.html#aws-glue-api-crawler-pyspark-extensions-dynamic-frame-writer-from_catalog
glue_ctx.write_dynamic_frame.from_catalog(
    DynamicFrame.fromDF(df, glue_ctx, "datasource"),
    database=database,
    table_name=table,
...
console_url = (
    f"https://{aws_region}.console.aws.amazon.com/athena/home?region={aws_region}#/query-editor/"
)
